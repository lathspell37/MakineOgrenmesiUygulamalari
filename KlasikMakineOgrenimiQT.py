...
# Form implementation generated from reading ui file 'KlasikMakineOgrenimiQT.ui'
#
...
class Ui_Dialog(QtWidgets.QMainWindow):
    ...
    def setupUi(self, Dialog):
        ...
        self.kFoldGroupBox = QtWidgets.QGroupBox(self.VeriOnislemeTab)
        self.kFoldGroupBox.setGeometry(QtCore.QRect(640, 20, 131, 80))
        self.kFoldGroupBox.setObjectName("kFoldGroupBox")
        self.kFoldButton = QtWidgets.QPushButton(self.kFoldGroupBox)
        self.kFoldButton.setGeometry(QtCore.QRect(80, 20, 41, 41))
        self.kFoldButton.setObjectName("kFoldButton")
        self.kFoldSpinBox = QtWidgets.QSpinBox(self.kFoldGroupBox)
        self.kFoldSpinBox.setGeometry(QtCore.QRect(20, 30, 42, 22))
        self.kFoldSpinBox.setObjectName("kFoldSpinBox")
        self.tabWidget.addTab(self.VeriOnislemeTab, "")
        self.tab_2 = QtWidgets.QWidget()
        self.tab_2.setObjectName("tab_2")
        self.classificationGroupBox = QtWidgets.QGroupBox(self.tab_2)
        self.classificationGroupBox.setGeometry(QtCore.QRect(10, 10, 181, 101))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(10, 120, 181, 101))
        ...
        self.grafikGroupBox.setGeometry(QtCore.QRect(210, 10, 551, 211))
        self.grafikGroupBox.setObjectName("grafikGroupBox")
        self.accuracyGrafikLabel = QtWidgets.QLabel(self.grafikGroupBox)
        self.accuracyGrafikLabel.setGeometry(QtCore.QRect(10, 20, 161, 171))
        ...
        self.rocGrafikLabel.setGeometry(QtCore.QRect(180, 10, 181, 181))
        ...
        self.confusionMatrixgrafikLabel.setGeometry(QtCore.QRect(376, 10, 161, 181))
        ...
        self.label_4.setGeometry(QtCore.QRect(290, 270, 47, 13))
        self.label_4.setObjectName("label_4")
        self.accuracyLabel = QtWidgets.QLabel(self.tab_2)
        self.accuracyLabel.setGeometry(QtCore.QRect(400, 270, 47, 13))
        self.accuracyLabel.setObjectName("accuracyLabel")
        self.mseLabel = QtWidgets.QLabel(self.tab_2)
        self.mseLabel.setGeometry(QtCore.QRect(400, 330, 47, 13))
        self.mseLabel.setObjectName("mseLabel")
        self.label_7 = QtWidgets.QLabel(self.tab_2)
        self.label_7.setGeometry(QtCore.QRect(290, 330, 47, 13))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.kFoldGroupBox.setTitle(_translate("Dialog", "K Fold"))
        self.kFoldButton.setText(_translate("Dialog", "Seç"))
