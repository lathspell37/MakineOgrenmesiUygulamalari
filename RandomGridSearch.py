...
# Form implementation generated from reading ui file 'RandomGridSearch.ui'
#
...
from sklearn.ensemble import RandomForestClassifier, RandomForestRegressor, BaggingClassifier, StackingClassifier, VotingClassifier
...
class Ui_Dialog(QtWidgets.QMainWindow):
    ...
    def Bagging(self):
        try:
            if self.decisionTreeBaggingradioButton.isChecked():
                ...
                self.accuracyEnsembleLBL.setText(str(accuracy_score(self.y_test, y_pred)))

            elif self.rfcBaggingradioButton.isChecked():
    ...
    def Boosting(self):
        try:
            if self.xgBoostingradioButton.isChecked():
                xgb_model = XGBClassifier().fit(self.X_train, self.y_train)
                y_pred = xgb_model.predict(self.X_test)
                xgboostAccuracy = accuracy_score(self.y_test, y_pred)
                self.accuracyEnsembleLBL.setText(str(xgboostAccuracy))
            elif self.catBoostingradioButton.isChecked():
                catboost_model = CatBoostClassifier().fit(self.X_train, self.y_train)
                y_pred = catboost_model.predict(self.X_test)
                catboostAccuracy = accuracy_score(self.y_test, y_pred)
                self.accuracyEnsembleLBL.setText(str(catboostAccuracy))
        except Exception as a:
            print(a)
    ...
    def Voting(self):
        try:
            if (self.svmVotingcheckBox.isChecked() and self.decisionTreeVotingcheckBox.isChecked() and self.knnVotingcheckBox.isChecked()):
                clf1 = SVC()
                clf2 = DecisionTreeClassifier()
                clf3 = KNeighborsClassifier()
                eclf1 = VotingClassifier(estimators=[('svc', clf1), ('dt', clf2), ('knn',clf3)], voting='hard')
                ...
                self.accuracyEnsembleLBL.setText(str(accuracyVoting))
                print('svc dt knn')
            elif (self.decisionTreeVotingcheckBox.isChecked() and self.knnVotingcheckBox.isChecked()):
                clf1 = DecisionTreeClassifier()
                clf2 = KNeighborsClassifier()
                eclf1 = VotingClassifier(estimators=[('svc', clf1), ('dt', clf2)], voting='hard')
                eclf1 = eclf1.fit(self.X_train, self.y_train)
                y_pred_eclf1 = eclf1.predict(self.X_test)
                accuracyVoting = accuracy_score(self.y_test, y_pred_eclf1)
                self.accuracyEnsembleLBL.setText(str(accuracyVoting))
                print('decisiontree knn')
            elif (self.svmVotingcheckBox.isChecked() and self.knnVotingcheckBox.isChecked()):
                clf1 = SVC()
                clf2 = KNeighborsClassifier()
                eclf1 = VotingClassifier(estimators=[('svc', clf1), ('dt', clf2)], voting='hard')
                eclf1 = eclf1.fit(self.X_train, self.y_train)
                ...
                self.accuracyEnsembleLBL.setText(str(accuracyVoting))
                print('svc knn')
            elif (self.svmVotingcheckBox.isChecked() and self.decisionTreeVotingcheckBox.isChecked()):
                clf1 = SVC()
                clf2 = DecisionTreeClassifier()
                eclf1 = VotingClassifier(estimators=[('svc', clf1), ('dt', clf2)], voting='hard')
                eclf1 = eclf1.fit(self.X_train, self.y_train)
    ...
    def setupUi(self, Dialog):
        ...
        self.TestSizeBox.setSingleStep(0.1)
        ...
        self.BoostinggroupBox = QtWidgets.QGroupBox(self.tab)
        self.BoostinggroupBox.setGeometry(QtCore.QRect(0, 0, 161, 80))
        self.BoostinggroupBox.setObjectName("BoostinggroupBox")
        self.xgBoostingradioButton = QtWidgets.QRadioButton(self.BoostinggroupBox)
        self.xgBoostingradioButton.setGeometry(QtCore.QRect(10, 20, 82, 17))
        self.xgBoostingradioButton.setObjectName("xgBoostingradioButton")
        self.catBoostingradioButton = QtWidgets.QRadioButton(self.BoostinggroupBox)
        self.catBoostingradioButton.setGeometry(QtCore.QRect(10, 40, 82, 17))
        self.catBoostingradioButton.setObjectName("catBoostingradioButton")
        self.BoostingpushButton = QtWidgets.QPushButton(self.BoostinggroupBox)
        self.BoostingpushButton.setGeometry(QtCore.QRect(100, 20, 41, 41))
        self.BoostingpushButton.setObjectName("BoostingpushButton")
        self.VotinggroupBox = QtWidgets.QGroupBox(self.tab)
        self.VotinggroupBox.setGeometry(QtCore.QRect(0, 80, 161, 80))
        self.VotinggroupBox.setObjectName("VotinggroupBox")
        self.svmVotingcheckBox = QtWidgets.QCheckBox(self.VotinggroupBox)
        self.svmVotingcheckBox.setGeometry(QtCore.QRect(10, 20, 70, 17))
        self.svmVotingcheckBox.setObjectName("svmVotingcheckBox")
        self.decisionTreeVotingcheckBox = QtWidgets.QCheckBox(self.VotinggroupBox)
        self.decisionTreeVotingcheckBox.setGeometry(QtCore.QRect(10, 40, 81, 17))
        self.decisionTreeVotingcheckBox.setObjectName("decisionTreeVotingcheckBox")
        self.VotingpushButton = QtWidgets.QPushButton(self.VotinggroupBox)
        self.VotingpushButton.setGeometry(QtCore.QRect(100, 20, 41, 41))
        self.VotingpushButton.setObjectName("VotingpushButton")
        self.knnVotingcheckBox = QtWidgets.QCheckBox(self.VotinggroupBox)
        self.knnVotingcheckBox.setGeometry(QtCore.QRect(10, 60, 70, 17))
        self.knnVotingcheckBox.setObjectName("knnVotingcheckBox")
        self.StackinggroupBox = QtWidgets.QGroupBox(self.tab)
        self.StackinggroupBox.setGeometry(QtCore.QRect(0, 160, 161, 80))
        self.StackinggroupBox.setObjectName("StackinggroupBox")
        self.svmStackingcheckBox = QtWidgets.QCheckBox(self.StackinggroupBox)
        self.svmStackingcheckBox.setGeometry(QtCore.QRect(10, 20, 70, 17))
        self.svmStackingcheckBox.setObjectName("svmStackingcheckBox")
        self.rfcStackingcheckBox = QtWidgets.QCheckBox(self.StackinggroupBox)
        self.rfcStackingcheckBox.setGeometry(QtCore.QRect(10, 40, 70, 17))
        self.rfcStackingcheckBox.setObjectName("rfcStackingcheckBox")
        self.StackingpushButton = QtWidgets.QPushButton(self.StackinggroupBox)
        self.StackingpushButton.setGeometry(QtCore.QRect(100, 20, 41, 41))
        self.StackingpushButton.setObjectName("StackingpushButton")
        self.knnStackingcheckBox = QtWidgets.QCheckBox(self.StackinggroupBox)
        self.knnStackingcheckBox.setGeometry(QtCore.QRect(10, 60, 70, 17))
        self.knnStackingcheckBox.setObjectName("knnStackingcheckBox")
        self.BagginggroupBox = QtWidgets.QGroupBox(self.tab)
        self.BagginggroupBox.setGeometry(QtCore.QRect(0, 240, 161, 80))
        self.BagginggroupBox.setObjectName("BagginggroupBox")
        self.decisionTreeBaggingradioButton = QtWidgets.QRadioButton(self.BagginggroupBox)
        self.decisionTreeBaggingradioButton.setGeometry(QtCore.QRect(10, 20, 82, 17))
        self.decisionTreeBaggingradioButton.setObjectName("decisionTreeBaggingradioButton")
        self.rfcBaggingradioButton = QtWidgets.QRadioButton(self.BagginggroupBox)
        self.rfcBaggingradioButton.setGeometry(QtCore.QRect(10, 40, 82, 17))
        self.rfcBaggingradioButton.setObjectName("rfcBaggingradioButton")
        self.BaggingpushButton = QtWidgets.QPushButton(self.BagginggroupBox)
        self.BaggingpushButton.setGeometry(QtCore.QRect(100, 20, 41, 41))
        self.BaggingpushButton.setObjectName("BaggingpushButton")
        self.GrafiklergroupBox = QtWidgets.QGroupBox(self.tab)
        self.GrafiklergroupBox.setGeometry(QtCore.QRect(170, 0, 591, 321))
        self.GrafiklergroupBox.setObjectName("GrafiklergroupBox")
        self.accuracyEnsemblegrafik = QtWidgets.QLabel(self.GrafiklergroupBox)
        self.accuracyEnsemblegrafik.setGeometry(QtCore.QRect(0, 10, 201, 301))
        self.accuracyEnsemblegrafik.setText("")
        self.accuracyEnsemblegrafik.setScaledContents(True)
        self.accuracyEnsemblegrafik.setObjectName("accuracyEnsemblegrafik")
        self.confusionEnsemblegrafik = QtWidgets.QLabel(self.GrafiklergroupBox)
        self.confusionEnsemblegrafik.setGeometry(QtCore.QRect(200, 20, 191, 301))
        self.confusionEnsemblegrafik.setText("")
        self.confusionEnsemblegrafik.setScaledContents(True)
        self.confusionEnsemblegrafik.setObjectName("confusionEnsemblegrafik")
        self.rocEnsemlegrafik = QtWidgets.QLabel(self.GrafiklergroupBox)
        self.rocEnsemlegrafik.setGeometry(QtCore.QRect(390, 20, 191, 291))
        self.rocEnsemlegrafik.setText("")
        self.rocEnsemlegrafik.setScaledContents(True)
        self.rocEnsemlegrafik.setObjectName("rocEnsemlegrafik")
        self.label_9 = QtWidgets.QLabel(self.tab)
        self.label_9.setGeometry(QtCore.QRect(100, 340, 47, 13))
        self.label_9.setObjectName("label_9")
        self.accuracyEnsembleLBL = QtWidgets.QLabel(self.tab)
        self.accuracyEnsembleLBL.setGeometry(QtCore.QRect(170, 340, 47, 13))
        self.accuracyEnsembleLBL.setText("")
        self.accuracyEnsembleLBL.setObjectName("accuracyEnsembleLBL")
        self.tabWidget.addTab(self.tab, "")
        self.tab_3 = QtWidgets.QWidget()
        self.tab_3.setObjectName("tab_3")
        self.RandomSearchgroupBox = QtWidgets.QGroupBox(self.tab_3)
        self.RandomSearchgroupBox.setGeometry(QtCore.QRect(0, 0, 131, 161))
        self.RandomSearchgroupBox.setObjectName("RandomSearchgroupBox")
        self.knnRandomSearchradioButton = QtWidgets.QRadioButton(self.RandomSearchgroupBox)
        self.knnRandomSearchradioButton.setGeometry(QtCore.QRect(10, 20, 82, 17))
        self.knnRandomSearchradioButton.setObjectName("knnRandomSearchradioButton")
        self.decisionTreeRandomTreeradioButton = QtWidgets.QRadioButton(self.RandomSearchgroupBox)
        self.decisionTreeRandomTreeradioButton.setGeometry(QtCore.QRect(10, 100, 82, 17))
        self.decisionTreeRandomTreeradioButton.setObjectName("decisionTreeRandomTreeradioButton")
        self.RandomSearchpushButton = QtWidgets.QPushButton(self.RandomSearchgroupBox)
        self.RandomSearchpushButton.setGeometry(QtCore.QRect(100, 10, 31, 41))
        self.RandomSearchpushButton.setObjectName("RandomSearchpushButton")
        self.label_11 = QtWidgets.QLabel(self.RandomSearchgroupBox)
        self.label_11.setGeometry(QtCore.QRect(10, 50, 71, 16))
        self.label_11.setObjectName("label_11")
        self.n_neighboursRandomLabel = QtWidgets.QLabel(self.RandomSearchgroupBox)
        self.n_neighboursRandomLabel.setGeometry(QtCore.QRect(10, 70, 91, 16))
        self.n_neighboursRandomLabel.setText("")
        self.n_neighboursRandomLabel.setObjectName("n_neighboursRandomLabel")
        self.label_12 = QtWidgets.QLabel(self.RandomSearchgroupBox)
        self.label_12.setGeometry(QtCore.QRect(10, 120, 61, 16))
        self.label_12.setObjectName("label_12")
        self.label_13 = QtWidgets.QLabel(self.RandomSearchgroupBox)
        self.label_13.setGeometry(QtCore.QRect(10, 140, 47, 13))
        self.label_13.setObjectName("label_13")
        self.max_depthRandomLabel = QtWidgets.QLabel(self.RandomSearchgroupBox)
        self.max_depthRandomLabel.setGeometry(QtCore.QRect(70, 120, 61, 16))
        self.max_depthRandomLabel.setText("")
        self.max_depthRandomLabel.setObjectName("max_depthRandomLabel")
        self.criterionRandomLabel = QtWidgets.QLabel(self.RandomSearchgroupBox)
        self.criterionRandomLabel.setGeometry(QtCore.QRect(70, 140, 61, 16))
        self.criterionRandomLabel.setText("")
        self.criterionRandomLabel.setObjectName("criterionRandomLabel")
        self.label_10 = QtWidgets.QLabel(self.tab_3)
        self.label_10.setGeometry(QtCore.QRect(10, 360, 47, 13))
        self.label_10.setObjectName("label_10")
        self.searchLabel = QtWidgets.QLabel(self.tab_3)
        self.searchLabel.setGeometry(QtCore.QRect(60, 360, 47, 13))
        self.searchLabel.setText("")
        self.searchLabel.setObjectName("searchLabel")
        self.groupBox = QtWidgets.QGroupBox(self.tab_3)
        self.groupBox.setGeometry(QtCore.QRect(130, 0, 631, 381))
        self.groupBox.setObjectName("groupBox")
        self.GridSearchgroupBox = QtWidgets.QGroupBox(self.tab_3)
        self.GridSearchgroupBox.setGeometry(QtCore.QRect(0, 160, 131, 161))
        self.GridSearchgroupBox.setObjectName("GridSearchgroupBox")
        self.gridSearchradioButton = QtWidgets.QRadioButton(self.GridSearchgroupBox)
        self.gridSearchradioButton.setGeometry(QtCore.QRect(10, 20, 82, 17))
        self.gridSearchradioButton.setObjectName("gridSearchradioButton")
        self.decisionTreeGridTreeradioButton = QtWidgets.QRadioButton(self.GridSearchgroupBox)
        self.decisionTreeGridTreeradioButton.setGeometry(QtCore.QRect(10, 100, 82, 17))
        self.decisionTreeGridTreeradioButton.setObjectName("decisionTreeGridTreeradioButton")
        self.GridSearchpushButton = QtWidgets.QPushButton(self.GridSearchgroupBox)
        self.GridSearchpushButton.setGeometry(QtCore.QRect(100, 10, 31, 41))
        self.GridSearchpushButton.setObjectName("GridSearchpushButton")
        self.label_14 = QtWidgets.QLabel(self.GridSearchgroupBox)
        self.label_14.setGeometry(QtCore.QRect(10, 50, 71, 16))
        self.label_14.setObjectName("label_14")
        self.n_neighboursGridLabel = QtWidgets.QLabel(self.GridSearchgroupBox)
        self.n_neighboursGridLabel.setGeometry(QtCore.QRect(10, 70, 91, 16))
        self.n_neighboursGridLabel.setText("")
        self.n_neighboursGridLabel.setObjectName("n_neighboursGridLabel")
        self.label_15 = QtWidgets.QLabel(self.GridSearchgroupBox)
        self.label_15.setGeometry(QtCore.QRect(10, 120, 61, 16))
        self.label_15.setObjectName("label_15")
        self.label_16 = QtWidgets.QLabel(self.GridSearchgroupBox)
        self.label_16.setGeometry(QtCore.QRect(10, 140, 47, 13))
        self.label_16.setObjectName("label_16")
        self.max_depthGridLabel = QtWidgets.QLabel(self.GridSearchgroupBox)
        self.max_depthGridLabel.setGeometry(QtCore.QRect(70, 120, 61, 16))
        self.max_depthGridLabel.setText("")
        self.max_depthGridLabel.setObjectName("max_depthGridLabel")
        self.criterionGridLabel = QtWidgets.QLabel(self.GridSearchgroupBox)
        self.criterionGridLabel.setGeometry(QtCore.QRect(70, 140, 61, 16))
        self.criterionGridLabel.setText("")
        self.criterionGridLabel.setObjectName("criterionGridLabel")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.BoostinggroupBox.setTitle(_translate("Dialog", "Boosting"))
        self.xgBoostingradioButton.setText(_translate("Dialog", "XG Boost"))
        self.catBoostingradioButton.setText(_translate("Dialog", "Cat Boost"))
        self.BoostingpushButton.setText(_translate("Dialog", "Seç"))
        self.VotinggroupBox.setTitle(_translate("Dialog", "Voting"))
        self.svmVotingcheckBox.setText(_translate("Dialog", "SVM"))
        self.decisionTreeVotingcheckBox.setText(_translate("Dialog", "Decision Tree"))
        self.VotingpushButton.setText(_translate("Dialog", "Seç"))
        self.knnVotingcheckBox.setText(_translate("Dialog", "KNN"))
        self.StackinggroupBox.setTitle(_translate("Dialog", "Stacking"))
        self.svmStackingcheckBox.setText(_translate("Dialog", "SVM"))
        self.rfcStackingcheckBox.setText(_translate("Dialog", "RFC"))
        self.StackingpushButton.setText(_translate("Dialog", "Seç"))
        self.knnStackingcheckBox.setText(_translate("Dialog", "KNN"))
        self.BagginggroupBox.setTitle(_translate("Dialog", "Bagging"))
        self.decisionTreeBaggingradioButton.setText(_translate("Dialog", "Decision Tree"))
        self.rfcBaggingradioButton.setText(_translate("Dialog", "RFC"))
        self.BaggingpushButton.setText(_translate("Dialog", "Seç"))
        self.GrafiklergroupBox.setTitle(_translate("Dialog", "Grafikler"))
        self.label_9.setText(_translate("Dialog", "Accuracy"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Dialog", "Ensemble Learning"))
        self.RandomSearchgroupBox.setTitle(_translate("Dialog", "Random Search"))
        self.knnRandomSearchradioButton.setText(_translate("Dialog", "KNN"))
        self.decisionTreeRandomTreeradioButton.setText(_translate("Dialog", "Decision Tree"))
        self.RandomSearchpushButton.setText(_translate("Dialog", "Seç"))
        self.label_11.setText(_translate("Dialog", "n_neighbours"))
        self.label_12.setText(_translate("Dialog", "max_depth"))
        self.label_13.setText(_translate("Dialog", "criterion"))
        self.label_10.setText(_translate("Dialog", "Accuracy"))
        self.groupBox.setTitle(_translate("Dialog", "Yapay Sinir Ağları"))
        self.GridSearchgroupBox.setTitle(_translate("Dialog", "Grid Search"))
        self.gridSearchradioButton.setText(_translate("Dialog", "KNN"))
        self.decisionTreeGridTreeradioButton.setText(_translate("Dialog", "Decision Tree"))
        self.GridSearchpushButton.setText(_translate("Dialog", "Seç"))
        self.label_14.setText(_translate("Dialog", "n_neighbours"))
        self.label_15.setText(_translate("Dialog", "max_depth"))
        self.label_16.setText(_translate("Dialog", "criterion"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("Dialog", "Grid&Random Search ve YSA"))
        ...
        self.BaggingpushButton.clicked.connect(self.Bagging)
        self.BoostingpushButton.clicked.connect(self.Boosting)
        self.StackingpushButton.clicked.connect(self.Stacking)
        self.VotingpushButton.clicked.connect(self.Voting)